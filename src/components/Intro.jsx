    ...
    return(
        <section className="bg-black py-20 px-6">
             <div className="max-w-5xl mx-auto text-center">
                ...
                <p className="text-2xl md:text-4xl text-gradient font-bold">Titânio. Tão forte. Tão Pro.</p>
             ...
             <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-16">
                ...
                <button className="border-2 border-white hover:bg-white hover:text-black text-white px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 hover:scale-105 shadow-lg cursor-pointer">Saiba mais</button>
             </div>

             <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mx-auto max-w-5xl">
                {space.map((spec, index) =>(
                    <div key={spec.index} className="bg-gray-900 rounded-2xl p-6 hover:bg-gray-800 cursor-pointer  transition-all duration-300 hover:scale-105">
